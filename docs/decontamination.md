...
1. git clone https://github.com/krutrim-ai-labs/indic-llm-eval-pipeline.git
2. pip install -r requirements.txt
3. Download The Pile from [The Eye](https://the-eye.eu/public/AI/pile/train/)
4. Place pile files in "pile" directory under "krutrim-ai-labs/indic-llm-eval-pipeline" (or create a symlink)
